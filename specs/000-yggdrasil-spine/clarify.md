...
INFERRED until operator flip.

- C1 This specialist is not Tier-1.
- C2 This repo does not replace Abraxas-v2.0 `core/yggdrasil/`.
- C3 v0 has no weights.
- C4 name_gate stays false. No encoder train. No Hub.
